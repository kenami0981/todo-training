...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseCharactersService, { provide: GETS_ALL_CHARACTERS_DTO, useExisting: FirebaseCharactersService }, { provide: GETS_ONE_CHARACTERS_DTO, useExisting: FirebaseCharactersService }],
  	exports: [] })
